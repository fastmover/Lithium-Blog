...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-download fade">
        ...
        {% } %}
		<td class="insert">
            <a class="btn btn-primary" data-wysihtml5-command="insertImage" data-wysihtml5-command-value="{%=file.url%}" href='javascript:InsertImage("{%=file.url%}");' >
...
$(function () {
	...
	// */
	//Wysihtml5
	var wysihtml5Editor = $('#wysihtml5-textarea').wysihtml5({
...
function InsertImage(imageurl){
	...
	this.window.wysihtml5.commands.exec("bold");
	wysihtml5Editor.composer.Commands.exec("bold");
	/*wysihtml5Editor.commands.insertImage("insertImage", { src: imageurl, alt: "ahh" });*/
}
</script>